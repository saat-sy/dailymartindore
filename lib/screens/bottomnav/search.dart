                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            onChanged: (val) => minPriceFinal = val,
                                                            decoration: InputDecoration(
                                                        ...
                                                        Container(
                                                          ...
                                                          child: TextFormField(
                                                            keyboardType:
                                                                TextInputType.numberWithOptions(decimal: true),
                                                            cursorColor: MyColors.PrimaryColor,
                                                            onChanged: (val) => maxPriceFinal = val,
                                                            decoration: InputDecoration(
                                                              contentPadding: EdgeInsets.symmetric(
                                                                  vertical: 0.0, horizontal: 10.0),
                                                              hintText: 'Max',
                                                  ...
                                                  Container(
                                                      ...
                                                      child: Container(
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (context, index) {
                                                            return CheckboxListTile(
                                                              title: Text(discountText[index]),
                                                              value: discount[index],
                                                              onChanged: (newValue) {
                                                                setState(() {
                                                                  discount[index] = newValue;
                                                                });
                                                              },
                                                              controlAffinity: ListTileControlAffinity.trailing,
                                                            );
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    onTap: () {
                                                      size.asMap().forEach((key, value) {
                                                        if (value) {
                                                          if (sizeFinal != '')
                                                            sizeFinal += ',' + sizeID[key];
                                                          else
                                                            sizeFinal += sizeID[key];
                                                        }
                                                      });

                                                      color.asMap().forEach((key, value) {
                                                        if (value) {
                                                          if (colorFinal != '')
                                                            colorFinal += ',' + colorID[key];
                                                          else
                                                            colorFinal += colorID[key];
                                                        }
                                                      });

                                                      discount.asMap().forEach((key, value) {
                                                        if (value) {
                                                          if (discountFinal != '')
                                                            discountFinal += ',' + discountID[key];
                                                          else
                                                            discountFinal += discountID[key];
                                                        }
                                                      });

                                                      ratings.asMap().forEach((key, value) {
                                                        if (value) {
                                                          if (ratingsFinal != '')
                                                            ratingsFinal += ',' + ratingsID[key];
                                                          else
                                                            ratingsFinal += ratingsID[key];
                                                        }
                                                      });
