  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        !_recordFound ? Container(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Image.asset("assets/images/empty_favorites.png"),
              Text('You have no favorites yet', style: TextStyle(fontSize: 25))
            ]
          ),
         ) :
         Container(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              RatingBarIndicator(
                                rating: favorites[index].rating != null
                                    ? double.parse(favorites[index].rating)
                                    : 0,
